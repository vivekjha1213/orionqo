                                            ...
                                            <Row>
                                                ...
                                                <Col md="6">
                                                    <div className="mb-3 position-relative">
                                                        ...
                                                        <Input type="text" className="form-control" id="validationTooltip01" value={last_name} name="last_name" placeholder="Last Name" onChange={this.handleChange} required/>
                                                        <div className="valid-tooltip">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                            ...
                                            <Row>
                                                <Col md="6">
                                                    <div className="mb-3 position-relative">
                                                        ...
                                                        <Input type="text" className="form-control" id="validationTooltip02" value={contact_number} name="contact_number" placeholder="Phone Number" onChange={this.handleChange} required/>
                                                        <div className="valid-tooltip">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                            ...
                                            <Row>
                                                ...
                                                <Col md="6">
                                                    <div className="mb-3 position-relative">
                                                        ...
                                                        <Input type="text" className="form-control" id="validationTooltip04" name="department" placeholder="Department" onChange={this.handleChange} required/>
                                                        <div className="valid-tooltip">
                                                            Looks good!
                                                        </div>
                                                    </div>
